...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { DOB: @dog.DOB, client_id: @dog.client_id, name: @dog.name } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { DOB: @dog.DOB, client_id: @dog.client_id, name: @dog.name } }

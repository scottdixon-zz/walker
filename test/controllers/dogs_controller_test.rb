...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { client_id_id: @dog.client_id_id, dob: @dog.dob, name: @dog.name } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { client_id_id: @dog.client_id_id, dob: @dog.dob, name: @dog.name } }
